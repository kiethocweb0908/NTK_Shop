...
const AddCollectionPage = () => {
  ...
  const validateInfo = (field) => {
    ...
    switch (field) {
      case 'name':
        ...
        const exists = collections.some((collection) => collection.name === info.name);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      {/* Tiêu đề */}
      <h2 className="text-2xl font-semibold uppercase mb-6 pt-7 px-7">Thêm bộ sưu tập</h2>
